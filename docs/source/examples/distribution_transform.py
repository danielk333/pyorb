...
axes[0].set_xlabel('X-velocity [km/s]', fontsize=20)
axes[0].set_ylabel('Y-velocity [km/s]', fontsize=20)

axes[1].plot(orb.a/pyorb.AU, orb.e, '.')
axes[1].set_title('Keplerian orbital shape', fontsize=22)
axes[1].set_xlabel('Semi-major axis [AU]', fontsize=20)
axes[1].set_ylabel('Eccentricity [1]', fontsize=20)
