...
latex_documents = [
    (master_doc, 'PyOrb.tex', 'PyOrb Documentation',
     'Daniel Kastinen', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyorb', 'PyOrb Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyOrb', 'PyOrb Documentation',
     author, 'PyOrb', 'One line description of project.',
     'Miscellaneous'),
]
